...
?>
    <div class="titleSubpage-01">
        <div class="wrapS tac">
            <h2>
                <?php echo $data->pages->mladysportovec->features->feature1->title; ?>
            </h2>

            <h3>
                <?php echo $data->pages->mladysportovec->features->feature1->subtitle; ?>
            </h3>
        </div>
    </div>
    ...
    <div class="titleSubpage-02">
        <div class="wrapS tac">
            <h2>
                <?php echo $data->pages->mladysportovec->features->feature2->title; ?>
            </h2>

            <h3>
                <?php echo $data->pages->mladysportovec->features->feature2->subtitle; ?>
            </h3>
        </div>
    </div>
